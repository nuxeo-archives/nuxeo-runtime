...
public class ConditionalIgnoreRule implements MethodRule {
    ...
    public static Condition IGNORE_ALWAYS = new IgnoreAlways();
    ...
    protected void checkIgnore(Ignore type, Method method,
        ...
        boolean shouldIgnore = condition.shouldIgnore(method, target);
        Assume.assumeThat(shouldIgnore, Matchers.is(false));
    }
